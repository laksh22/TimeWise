      ...
      >
        <View style={styles.modal}>
          ...
          <View style={styles.timeButtonRow}>
            <Button title={timeSamples[0]} onPress={() => setTime(timeSamples[0])} />
            <Button title={timeSamples[1]} onPress={() => setTime(timeSamples[1])} />
            <Button title={timeSamples[2]} onPress={() => setTime(timeSamples[2])} />
          </View>
          <View style={styles.timeButtonRow}>
            <Button title={timeSamples[3]} onPress={() => setTime(timeSamples[3])} />
            <Button title={timeSamples[4]} onPress={() => setTime(timeSamples[4])} />
          </View>
          <View style={styles.buttonRow}>
            <TouchableWithoutFeedback
                onPress={() => {
